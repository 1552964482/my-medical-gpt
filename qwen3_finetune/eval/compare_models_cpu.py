...
def load_model(model_path, lora_path=None, device="cpu"):
    """
    加载模型
...
def generate_answer(model, tokenizer, question, max_new_tokens=256, temperature=0.7):
    """
    生成答案
